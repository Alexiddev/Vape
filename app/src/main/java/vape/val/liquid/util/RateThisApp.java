 ...
 * modified v.aleksandrenko on 01.08.2016.
 */
public class RateThisApp {
    ...
    private static void showRateDialog(final Context context, AlertDialog.Builder builder) {
        ...
        int titleId = sConfig.mTitleId != 0 ? sConfig.mTitleId : vape.val.liquid.R.string.rta_dialog_title;
        int messageId = sConfig.mMessageId != 0 ? sConfig.mMessageId : vape.val.liquid.R.string.rta_dialog_message;
        int thanksButtonID = sConfig.mNoButtonId != 0 ? sConfig.mNoButtonId : vape.val.liquid.R.string.rta_dialog_no;
