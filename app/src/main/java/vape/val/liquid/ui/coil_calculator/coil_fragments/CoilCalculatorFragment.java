...
public class CoilCalculatorFragment extends Fragment {
    ...
    public void calculateCoil() {
        ...
        double numberOfWires = RadioButtonWithTableLayout.wires;
        coil.setNumberOfWires(numberOfWires);

        double pigtail = switchPigtail.isChecked() ? 1.0: 0.0;
        coil.setPigtail(pigtail);

        double numberOfSpirals = RadioButtonWithTableLayout.spirals;
        coil.setNumberOfSpirals(numberOfSpirals);

        double spiralsType = RadioButtonWithTableLayout.spirals_type;
        String spiral = null;
   ...
   //     if (werst == 1) { var r_resist = r_resist * ohm_correct; }
    ...
    public static void der() {
      CoilCalculatorFragment coilCalculatorFragment = new CoilCalculatorFragment();
        coilCalculatorFragment.calculateCoil();
    }
